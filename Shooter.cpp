...
void Shooter::LoadArrow(int iTime, Horizontal_Scene* scene) {
...
void Shooter::UpdateArrowPos(Horizontal_Scene* scene, vSpriteSet npc_set) {
...
void Shooter::ArrowCollide(T_Sprite* arrow, Horizontal_Scene* scene, vSpriteSet npc_set) {
