...
public:
	...
	void LoadArrow(int iTime, T_Scene* scene);
	void UpdateArrowPos(T_Scene* scene, vSpriteSet npc_set);
	void ArrowCollide(T_Sprite* arrow, T_Scene* scene, vSpriteSet npc_set);
};
